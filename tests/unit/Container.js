			...
			"basic": {
				...
				tests: {
					...
					getIndexOfChild: function () {
						...
						assert.strictEqual(c.getIndexOfChild(document.getElementById("outsideCont")), -1,
							"outsideCont test");
					},
				...
				before: function () {
					TestContainer = register("my-container-node", [HTMLElement, Container], {
						initializeRendering: function () {
							// during initializeRendering(), this.appendChild() should always go to root node, so
