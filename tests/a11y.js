define([
	...
	var container, html;
		...
		"findTabNullOnEmpty" : function () {
			// TODO: doh test handles both null & undefined: see all (null || undefined), deepEqual ok like this?
			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("empty"));
			assert.deepEqual(null || undefined, a11y.getLastInTabbingOrder("empty"));
		},
		"findTabElements" : function () {
			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("div-container"));
			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("a-without-href-container"));
			...
			assert.deepEqual(null || undefined, a11y.getLastInTabbingOrder("div-container"));
			assert.deepEqual(null || undefined, a11y.getLastInTabbingOrder("a-without-href-container"));
		...
		"skipNotShown" : function () {
			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("hidden-element-container"));
			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("hidden-container-tabindex-zero"));
			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("hidden-container-no-tabindex"));
			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("container-with-hidden-containers"));

			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("display-none-element-container"));
			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("display-none-container-tabindex-zero"));
			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("display-none-container-no-tabindex"));
			assert.deepEqual(null || undefined, a11y.getFirstInTabbingOrder("container-with-display-none-containers"));
		},
