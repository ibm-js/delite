...
```bash
$ git clone git@github.com:username/delite.git
```

This will clone your fork to your current path in a directory named `delite`.
...
```bash
$ cd delite
$ git remote add upstream git@github.com:ibm-dojo/delite.git
$ git fetch upstream
```
