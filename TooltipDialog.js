// dijit/TooltipDialog code, to be possibly use for popups (iOS on table encases popups in tooltips)
...
define([
	...
	"./DialogBase"
	// template
], function (dcl, has, keys, domClass, ContentPane, _TemplatedMixin, FormWidget, DialogBase, template) {

	var TooltipDialog = dcl([ContentPane, _TemplatedMixin, FormWidget, DialogBase], {
		// summary:
	...
	if (has("bidi")) {
		TooltipDialog.extend({
			_setTitleAttr: function (/*String*/ title) {
				this.containerNode.title = (this.textDir && this.enforceTextDirWithUcc) ?
					this.enforceTextDirWithUcc(null, title) : title;
